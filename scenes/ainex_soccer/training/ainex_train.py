...
from scenes.ainex_soccer.env import AINexEnv
...
def main():
    parser = argparse.ArgumentParser(description="Train PPO for AINex standing task.")
    ...
    log_dir = os.path.join("logs", "ainex_stand")
    ...
    save_path = "scenes/ainex_soccer/policies/ppo_ainex_stand"
